...
job-name-arifactspecialist = специалист по артефактам
job-name-roboticist = роботехник
job-name-genetics = генетик
job-name-psychologist = психолог
job-name-Catgirl = Кошко горничная
job-name-blueshield = Офицер "Блюшилд"
...
job-name-centcomadm = центком адмирал
