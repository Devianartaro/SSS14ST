...
namespace Content.Shared.CCVar
{
    ...
    public sealed class CCVars : CVars
    {
        ...
        public static readonly CVarDef<float> AmbientCooldown =
            CVarDef.Create("ambience.cooldown", 3.0f, CVar.ARCHIVE | CVar.CLIENTONLY);

        /// <summary>
        /// How large of a range to sample for ambience.
        /// </summary>
        public static readonly CVarDef<float> AmbientRange =
            CVarDef.Create("ambience.range", 4f, CVar.REPLICATED | CVar.SERVER);

        /// <summary>
        /// Maximum simultaneous ambient sounds.
        /// </summary>
        public static readonly CVarDef<int> MaxAmbientSources =
            CVarDef.Create("ambience.max_sounds", 8, CVar.ARCHIVE | CVar.CLIENTONLY);
        ...
        public static readonly CVarDef<int> MinMaxAmbientSourcesConfigured =
            CVarDef.Create("ambience.min_max_sounds_configured", 8, CVar.REPLICATED | CVar.SERVER | CVar.CHEAT);
        ...
        public static readonly CVarDef<int> MaxMaxAmbientSourcesConfigured =
            CVarDef.Create("ambience.max_max_sounds_configured", 16, CVar.REPLICATED | CVar.SERVER | CVar.CHEAT);
        ...
        /// </summary>
        public static readonly CVarDef<int>
            GameMapMemoryDepth = CVarDef.Create("game.map_memory_depth", 4, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<float> MaxStationOffset =
            CVarDef.Create("game.maxstationoffset", 100.0f);
        ...
        public static readonly CVarDef<int> SoftMaxPlayers =
            CVarDef.Create("game.soft_max_players", 45, CVar.SERVERONLY | CVar.ARCHIVE);
        ...
        public static readonly CVarDef<string> DiscordAHelpWebhook =
            CVarDef.Create("discord.ahelp_webhook", "https://discord.com/api/webhooks/1047609834624798842/u-LrQ_4J0rWRrozbDh0xQz25Ua9wo8ac0Q3MmwQrGjLpCWu9c2Xy2ARFtAcdQS3WbPAp", CVar.SERVERONLY);
        ...
        public static readonly CVarDef<int> SuspicionStartingBalance =
            CVarDef.Create("suspicion.starting_balance", 15);
        ...
        public static readonly CVarDef<int> TraitorCodewordCount =
            CVarDef.Create("traitor.codeword_count", 3);

        public static readonly CVarDef<int> TraitorStartingBalance =
            CVarDef.Create("traitor.starting_balance", 15);
        ...
        public static readonly CVarDef<int> TraitorDeathMatchStartingBalance =
            CVarDef.Create("traitordm.starting_balance", 100);
        ...
        public static readonly CVarDef<int> ZombiePlayersPerInfected =
            CVarDef.Create("zombie.players_per_infected", 5);
        ...
        public static readonly CVarDef<int> NPCMaxUpdates =
            CVarDef.Create("npc.max_updates", 48);
        ...
        public static readonly CVarDef<float> NetAtmosDebugOverlayTickRate =
            CVarDef.Create("net.atmosdbgoverlaytickrate", 1.0f);

        public static readonly CVarDef<float> NetGasOverlayTickRate =
            CVarDef.Create("net.gasoverlaytickrate", 1.0f);

        public static readonly CVarDef<int> GasOverlayThresholds =
            CVarDef.Create("net.gasoverlaythresholds", 10);
        ...
        public static readonly CVarDef<int> ExplosionThrowLimit =
            CVarDef.Create("explosion.throw_limit", 200, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<int> ExplosionMaxIterations =
            CVarDef.Create("explosion.max_iterations", 250, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<float> ExplosionPersistence =
            CVarDef.Create("explosion.persistence", 0.5f, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<int> ExplosionSingleTickAreaLimit =
            CVarDef.Create("explosion.single_tick_area_limit", 200, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<float> RadiationMinIntensity =
            CVarDef.Create("radiation.min_intensity", 1.0f, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<float> RadiationGridcastMaxDistance =
            CVarDef.Create("radiation.gridcast.max_distance", 30f, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<int> AdminLogsQueueMax =
            CVarDef.Create("adminlogs.queue_max", 500, CVar.SERVERONLY);

        public static readonly CVarDef<int> AdminLogsPreRoundQueueMax =
            CVarDef.Create("adminlogs.pre_round_queue_max", 500, CVar.SERVERONLY);

        // How many logs to send to the client at once
        public static readonly CVarDef<int> AdminLogsClientBatchSize =
            CVarDef.Create("adminlogs.client_batch_size", 100, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<bool> BrandingSteam = CVarDef.Create("branding.steam", true, CVar.CLIENTONLY);
        ...
        public static readonly CVarDef<float> VoteSameTypeTimeout =
            CVarDef.Create("vote.same_type_timeout", 1200f, CVar.SERVERONLY);
        ...
        /// </summary>
        public static readonly CVarDef<int>
            VoteTimerMap = CVarDef.Create("vote.timermap", 50, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<float> EmergencyShuttleTransitTime =
            CVarDef.Create("shuttle.emergency_transit_time", 45f, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<int> EmergencyShuttleAutoCallTime =
            CVarDef.Create("shuttle.auto_call_time", 60, CVar.SERVERONLY);
        ...
        /// </summary>
        public static readonly CVarDef<int>
            FlavorLimit = CVarDef.Create("flavor.limit", 5, CVar.SERVERONLY);
        ...
        /// </summary>
        public static readonly CVarDef<float>
            AutosaveInterval = CVarDef.Create("mapping.autosave_interval", 900f, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<float> UpdateRestartDelay =
            CVarDef.Create("update.restart_delay", 30f, CVar.SERVERONLY);
        ...
        /// </summary>
        public static readonly CVarDef<float>
            PlayTimeSaveInterval = CVarDef.Create("playtime.save_interval", 300f, CVar.SERVERONLY);
        ...
        public static readonly CVarDef<string> InfoLinksDiscord =
            CVarDef.Create("infolinks.discord", "https://discord.com/invite/CK5VgQmXPC", CVar.SERVER | CVar.REPLICATED);
        ...
        public static readonly CVarDef<string> InfoLinksGithub =
            CVarDef.Create("infolinks.github", "https://github.com/space-wizards/space-station-14", CVar.SERVER | CVar.REPLICATED);

        /// <summary>
        /// Link to website to show in the launcher.
        /// </summary>
        public static readonly CVarDef<string> InfoLinksWebsite =
            CVarDef.Create("infolinks.website", "https://boosty.to/ss14stray", CVar.SERVER | CVar.REPLICATED);

        /// <summary>
        /// Link to wiki to show in the launcher.
        /// </summary>
        public static readonly CVarDef<string> InfoLinksWiki =
            CVarDef.Create("infolinks.wiki", "https://station14.ru/wiki/", CVar.SERVER | CVar.REPLICATED);

        /// <summary>
        /// Link to Patreon. Not shown in the launcher currently.
        /// </summary>
        public static readonly CVarDef<string> InfoLinksPatreon =
            CVarDef.Create("infolinks.patreon", "https://boosty.to/ss14stray", CVar.SERVER | CVar.REPLICATED);
        ...
        public static readonly CVarDef<string> DiscordRoundWebhook =
            CVarDef.Create("discord.round_webhook", "https://discord.com/api/webhooks/1047610763344367750/UCzbAMgFFJxWSi9MF5mXoyg0g-abPHuIjxU908pxe6ghaFdVFOlD6_O4jF0tlf6Zbcex", CVar.SERVERONLY);

        public static readonly CVarDef<string> DiscordRoundRoleId =
            CVarDef.Create("discord.round_roleid", "1044334970556125184", CVar.SERVERONLY);
